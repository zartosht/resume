...
function fillTemplate() {
  ...
  if (profile.picture != "") {
    ...
    $("#profileImgPrint").attr("src", profile.picture);
  }
  $("#profileImg").attr("alt", profile.name);
  $("#profileImgPrint").attr("alt", profile.name);
  // About
  $("#smallName").text(profile.name);
  $("#name")
    .find(".first")
    .text(profile.name.split(" ")[0] + " " + profile.name.split(" ")[1]);
  $("#name").find(".second").text(profile.name.split(" ").slice(2).join(" "));
  document.getElementById("location").innerHTML = profile.location;
  document.getElementById("age").innerHTML = `${birth.getFullYear()}/${
    birth.getMonth() + 1
  }/${birth.getDate()}`;
  ...
  document
    ...
    .setAttribute("href", profile.social.linkedin);
  document.getElementById("linkedinPrint").innerHTML = profile.social.linkedin;
  document
    .getElementById("githubPrint")
    .setAttribute("href", profile.social.github);
  document.getElementById("githubPrint").innerHTML = profile.social.github;
  document
    .getElementById("twitterPrint")
    .setAttribute("href", profile.social.twitter);
  document.getElementById("twitterPrint").innerHTML = profile.social.twitter;
  document
    .getElementById("stackoverflowPrint")
    .setAttribute("href", profile.social.stackoverflow);
